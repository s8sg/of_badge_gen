...
| [![failure_DEPLOY](https://img.shields.io/badge/openfaas--cloud-unknown-lightgrey.svg)](https://img.shields.io/badge/openfaas--cloud-unknown-lightgrey.svg) | Failed to Deploy |
...
`of_badge_gen` is not dependent to `openfaas-cloud` but it fetch the build status from repo.
```
https://api.github.com/repos/?user/?repo/commits/?branch/status"
```
and verify if the status generated by a openfaas-cloud
